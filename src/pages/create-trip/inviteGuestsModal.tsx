...
interface InviteGuestsModalProps {
    closeGuestsModal: () => void //uma função sem retorno
    ...
    return (  
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
            <div className="max-w-[94%] w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
                ...
                <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2 flex-wrap">
